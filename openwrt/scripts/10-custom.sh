...
# mihomo
    ...
    #kdir -p files/etc/mihomo/run/ui
...
curl -fsSL https://raw.githubusercontent.com/0118Add/OpenWrt-Actions/master/personal/os-release > package/base-files/files/etc/os-release
