...
#sed -i '$a src-git PWpackages https://github.com/xiaorouji/openwrt-passwall-packages.git;main' feeds.conf.default
...
if [ "$str1" = "5.4" ];then
   ...
   mv  bin/targets/x86/64/immortalwrt-x86-64-generic-squashfs-combined.img.gz       bin/targets/x86/64/immortalwrt_x86-64_${str1}.${ver510}_bios.img.gz
   mv  bin/targets/x86/64/immortalwrt-x86-64-generic-squashfs-combined-efi.img.gz   bin/targets/x86/64/immortalwrt_x86-64_${str1}.${ver510}_uefi.img.gz
elif [ "$str1" = "5.15" ];then
   ...
   if [ ! $ver61 ]; then
   mv  bin/targets/x86/64/immortalwrt-x86-64-generic-squashfs-combined.img.gz       bin/targets/x86/64/immortalwrt_x86-64_${str1}.${ver61}0_bios.img.gz
   mv  bin/targets/x86/64/immortalwrt-x86-64-generic-squashfs-combined-efi.img.gz   bin/targets/x86/64/immortalwrt_x86-64_${str1}.${ver61}0_uefi.img.gz
  else
   ...
   if [ ! $ver66 ]; then
   mv  bin/targets/x86/64/immortalwrt-x86-64-generic-squashfs-combined.img.gz       bin/targets/x86/64/immortalwrt_x86-64_${str1}.${ver66}0_bios.img.gz
   mv  bin/targets/x86/64/immortalwrt-x86-64-generic-squashfs-combined-efi.img.gz   bin/targets/x86/64/immortalwrt_x86-64_${str1}.${ver66}0_uefi.img.gz
  else
   mv  bin/targets/x86/64/immortalwrt-x86-64-generic-squashfs-combined.img.gz       bin/targets/x86/64/immortalwrt_x86-64_${str1}.${ver66}_bios.img.gz
   mv  bin/targets/x86/64/immortalwrt-x86-64-generic-squashfs-combined-efi.img.gz   bin/targets/x86/64/immortalwrt_x86-64_${str1}.${ver66}_uefi.img.gz
   fi
fi
#md5
